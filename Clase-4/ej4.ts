...
const historialP:any[]=[];

const gastosPaciente:string[]=[];//lista de medicamentos del paciente
...
class Recepcion extends PersonaVete{
    ...
    agregarPacienteHistorial(paciente:any){
        pacientesPorAtender.push(paciente)
    }

    cobrarConsulta(consulta=1000,cantMedicamento:number){
        let total=0;
